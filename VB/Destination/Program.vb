    ...
    Friend Class Program
        ...
        Shared Sub Main(ByVal args As String())
            ...
            Using documentProcessor As DevExpress.Pdf.PdfDocumentProcessor = New DevExpress.Pdf.PdfDocumentProcessor()
                ...
                ' Get bookmark list. 
                Dim bookmarks As IList(Of DevExpress.Pdf.PdfBookmark) = documentProcessor.Document.Bookmarks
                For Each word As String In words
                    ...
                    If results.Status Is DevExpress.Pdf.PdfTextSearchStatus.Found Then
                        Dim destination As DevExpress.Pdf.PdfXYZDestination = New DevExpress.Pdf.PdfXYZDestination(results.Page, 0, results.Rectangles(0).Top, Nothing)
